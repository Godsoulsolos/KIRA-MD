...
*
   ...
   * @author : Godsoulsolos
   * @youtube : https://www.youtube.com/c/@HSCLAN
   * @description : KIRA-MD ,A Multi-functional whatsapp user bot.
   * @version 1.2.2
*
   * Licensed under the  GPL-3.0 License;
* 
   * Created By Godsoulsolos.
   * © 2023 Kira.
* 
...
async(KIRA msg, text) => {
 ...
 KIRA.bot.sendMessage( msg.chat, { image: {  url: result.images.jpg.large_image_url, }, caption: details, }, { quoted: msg,});
}
   )
//---------------------------------------------------------------------------